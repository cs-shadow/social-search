  ...
  <footer class="site-footer">
    <ul class="nav navbar-nav navbar-left">           
      <li><a href="/">&copy; Social Search 2014</a></li>
    </ul>
 ...
 <!-- Load JS here for greater good =============================-->
    <script src="../static/css/Flat-UI-master/js/jquery-1.8.3.min.js"></script>
    <script src="../static/css/Flat-UI-master/js/jquery-ui-1.10.3.custom.min.js"></script>
